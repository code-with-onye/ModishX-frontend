  ...
  return (
    <div className="footer">
      <div className="footer__sectionOne">
        ...
        <p>
          We are a team of talents pioneering blockchain adaptation into the
          Fashion industry using thw Metaverse. We aim improve shopping
          experience and be the fashion hub got in-game avatars
        </p>
