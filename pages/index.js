  ...
  const [data, setData] = useState([
    {
      ...
      short_description: "A taste of Overall made for easy wear and comfortable movement in the metaverse world"
    },
    {
      ...
      <Layout titleText={"Home | Mudish-X"} page={1}>
        <div className="mudishx__home__main__sectionTwo__first__auth__container">
          ...
          <section className="section latest__wearables">
            <h3 className="latest__wearables__heading">
              Latest Wearables
            </h3>
          ...
          <section className="features section">
            <div className="features__header__container">
              ...
              <p>
                ...
                intend to leverage the possibility of using the Metaverse to Strengthen 
                the relationship between the fashion house/designers and their consumers.
              </p>
            </div>
              ...
              <div className="features__body__container__sectionTwo">
                <div className="features__body__container__sectionTwo__item">
                  ...
                  <div className="features__body__container__sectionTwo__item__textContainer">
                    <h1>NFT Purchase</h1>
                    <p>Get an NFT of digital wearables serving as digital assets with utility functions</p>
                ...
                <div className="features__body__container__sectionTwo__item">
                  ...
                  <div className="features__body__container__sectionTwo__item__textContainer">
                    ...
                    <p>Auction and Bid for any digital fashion wearable at a price of your choice on the Auction section of Mudish-X marketplace</p>
                ...
                <div className="features__body__container__sectionTwo__item">
                  ...
                  <div className="features__body__container__sectionTwo__item__textContainer">
                    ...
                    <p>MudishX enables you Purchase Digital wearable for your in-game avatar and make it possible to redeem this digital wearable to Physical wearable</p>
                  </div>
                </div>
                ...
                <div className="features__body__container__sectionTwo__item">
                  ...
                  <div className="features__body__container__sectionTwo__item__textContainer">
                    ...
                    <p>Purchasing a wearable at MudishX gives you exclusive right of ownership of the NFT and the wearable provided you still own them</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="services__list__container">
            <div className="services__item">
              ...
              <div className="services__icon__body">
                <p>
                  Explore the Metaverse in Amazing and Unique Fashion collectables from MudishX NFT Marketplace
                </p>
              </div>
            </div>
            ...
            <div className="services__item">
              ...
              <div className="services__icon__header">
                <h3>Redeem NFT Fashion collectable from the Metaverse to the real world </h3>
              </div>
              <div className="services__icon__body">
                <p>
                  On MudishX all Collectables are backed up with it corresponding real world Fashion Item and can be redeemed for the real world item from the Metaverse
                </p>
              </div>
            </div>
            ...
            <div className="services__item">
              ...
              <div className="services__icon__body">
                <p>
                  You have a chance to borrow any of product for a specified amount of time
                </p>
              </div>
            </div>
            ...
            <div className="services__item">
              ...
              <div className="services__icon__body">
                <p>
                  Get Updates on New Wearables, Cryptocurrencies news and things happening in the metaverse
                </p>
              </div>
            </div>
          </div>
