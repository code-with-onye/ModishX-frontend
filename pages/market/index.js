      ...
      <Layout titleText={"Market | Mudish-X"} page={2}>
        <div className="marketplace__header">
          ...
          <div className="marketplace__header__sectionTwo">
            ...
            <h3 className="marketplace__header__sectionTwo__textContainer">
              Instance Purchase
            </h3>
          </div>
          <div className="marketplace__header__sectionThree">
            ...
            <Button className="marketplace__header__sectionTwo__addressButton">
              0Xbfex...fde
            </Button>
          </div>
        </div>
              ...
              {tabs.map((tab, index) => {
                return (
                  <button
                    ...
                    className={
                      activeTab === tab
                        ? "marketplace__list__main__tabs__wrapper__tab__nav__item marketplace__list__main__tabs__wrapper__tab__nav__item-active"
                        : "marketplace__list__main__tabs__wrapper__tab__nav__item"
                    }
                    onClick={() => {
                      setActiveTab(tab);
                    }}
        ...
        <section className="active">activity</section>
      </Layout>
    </div>
  );
}
